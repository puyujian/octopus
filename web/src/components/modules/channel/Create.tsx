...
export function CreateDialogContent() {
    ...
    return (
        <div className="flex h-auto max-h-full min-h-0 w-full min-w-0 flex-col">
            ...
            <MorphingDialogDescription disableLayoutAnimation className="flex-none overflow-visible">
                <ChannelForm
                    formData={formData}
